...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #2e7be8 1px solid;BORDER-TOP: #2e7be8 1px solid;BORDER-LEFT: #2e7be8 1px solid;';
strFrame+='BORDER-BOTTOM: #2e7be8 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#2e7be8 bgcolor=#2e7be8 Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#2e7be8 style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='        <td width=16 bgcolor=#2e7be8 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#2e7be8 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#2e7be8 BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
...
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#2e7be8 BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
...
strFrame+='             Author=meizz align=center><input Author=meizz type=button class=button value=Now onclick="parent.meizzToday()" ';
strFrame+='             onfocus="this.blur()" title="当前日期" style="font-size: 12px; height: 20px; cursor:hand"><input Author=meizz type=button class=button value=Del onclick="parent.meizzClear()" ';
strFrame+='             onfocus="this.blur()" title="清空日期" style="font-size: 12px; height: 20px; cursor:hand"></td><td ';
...
function meizzClear()  //Today Button
  {
    if(outObject){
        outObject.value="";
    }
