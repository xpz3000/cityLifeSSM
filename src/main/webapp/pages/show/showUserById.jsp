...
<table class="table table-hover">
		...
		<c:forEach items="${users}"  var="u">
			...
			<td><button type="button" class="btn btn-default btn-s"><a href="removeUser?id=${u.id}"><i class="glyphicon glyphicon-trash"></i></a></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="adminUpdateStu">
